                                                    ...
                                                    //а яв.  маркером, говорящим, что данный класс реализует клонирование (глубокое)объекта - метод Clone()
{
    ...
    public abstract String additionalInformation(); //бстрактный метод добавляет доп. информацию о конкретном типе карты SkiPass к стандартному описанию toString() переоредилим в наследниках
